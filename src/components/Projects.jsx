    ...
    return (
        ...
        >
            ...
            <div
                ...
                {project === 'space' ? <img src={space} alt='space tourism' /> : project === 'todo' ? <img src={todo} alt='todo' /> : project === 'audn' ? <img src={audn} alt='audn' /> : project === 'olivia' ? <img src={olivia2} alt='olivia' /> : null}
            </div>
            {hover && project !== '' ? <div className="project-img blur">
                ...
                <div className="icons">
                    ...
                    <a href={project === 'space' ? 'https://vperaltaspacetourism.netlify.app/' : project === 'todo' ? 'https://todolistvperalta.netlify.app/' : project === 'olivia' ? 'https://olivianailstudio.vercel.app//' : null} target='_blank'>
            ...
            <div
                ...
                className="description">{project === 'space' ? <p>Solution of the Space tourism website challenge from Frontend Mentor.
                    ...
                    project === 'olivia' ? <p> The website of a nail salon, featuring an online appointment system, payment through MercadoPago, and an admin dashboard. Built with Next.js.</p> :
                        null}</div>
        </div >
