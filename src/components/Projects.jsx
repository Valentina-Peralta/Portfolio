...
import audnDemo from '../assets/images/audn-demo.mp4'
import appointify from '../assets/images/appointify.png'
function projects() {

    const [project, setproject] = useState('appointify')
    ...
    return (
        ...
        >
            ...
            >
                <h3
                    id={project === 'appointify' ? 'active' : null}
                    onMouseEnter={() => {
                        setproject('appointify')
                        setHover(false)
            ...
            <div
                ...
                {project === 'space' ? <img src={space} alt='space tourism' /> : project === 'todo' ? <img src={todo} alt='todo' /> : project === 'audn' ? <img src={audn} alt='audn' /> : project === 'appointify' ? <img src={appointify} alt='appointify' /> : null}
            </div>
            {hover && project !== '' ? <div className="project-img blur">

                <div className="icons">
                    <a href={project === 'space' ? 'https://github.com/Valentina-Peralta/Space-tourism.git' : project === 'todo' ? 'https://github.com/Valentina-Peralta/Todo-list.git' : project === 'audn' ? 'https://github.com/Valentina-Peralta/proyecto-final-senpai.git' : project === 'appointify' ? 'https://github.com/Valentina-Peralta/appointify' : null} target='_blank'>
                        <svg
                            xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 256 256" width="64px" height="64px" fillOpacity="1" fill={project === 'appointify' ? '#000000' : "#FFFFFF"} stroke="none" strokeWidth="1" strokeLinecap="butt" strokeLinejoin="miter" strokeMiterlimit="10" strokeDasharray="" strokeDashoffset="0" fontFamily="none" fontWeight="none" fontSize="none" textAnchor="none" style={{ mixBlendMode: 'normal' }}>
