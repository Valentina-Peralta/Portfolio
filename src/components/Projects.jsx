    ...
    return (
        ...
        >
            ...
            {hover && project !== '' ? <div className="project-img blur">
                <div className="icons">
                    <a href={project === 'space' ? 'https://github.com/Valentina-Peralta/Space-tourism.git' : project === 'todo' ? 'https://github.com/Valentina-Peralta/Todo-list.git' : project === 'audn' ? 'https://github.com/Valentina-Peralta/projecto-final-senpai.git' : null} target='_blank'>
                        <svg
                    ...
                    <a href={project === 'space' ? 'https://vperaltaspacetourism.netlify.app/' : project === 'todo' ? 'https://todolistvperalta.netlify.app/' : null} target='_blank'>
